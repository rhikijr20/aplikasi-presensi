...
<body class="bg-gray-100 font-roboto">
  ...
  <div class="bg-[#192f46] text-white p-4">
    ...
    <div class="flex items-center mt-4">
      <div class="flex-1">
        <div class="text-lg font-bold">Agung Tauhid</div>
        <div class="text-sm">Siswa</div>
      </div>
      <img src="https://storage.googleapis.com/a1aa/image/fImrG2DWoXXBda8JiPtUPOF63eg3bnlfziFshnji56cVCKQnA.jpg" alt="Profile Picture" class="w-12 h-12 rounded-full" width="50" height="50" />
    </div>
  </div>
  ...
  <div class="p-4">
    ...
    <!-- Surat Izin Start -->
    <a href="/suratizin" class="block bg-white p-4 rounded-lg shadow flex items-center justify-between">
      <div class="flex items-center space-x-2">
